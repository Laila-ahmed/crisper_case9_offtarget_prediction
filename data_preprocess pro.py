# -*- coding: utf-8 -*-
"""
Created on Thu May  6 07:52:57 2021
...
outputList = "output\off_Glove.txt"
outputList1 = "output\hek293_off_Glove.txt"
outputList2 = "output\K562_off_Glove.txt"
...
coocPath = "output\cooccurrence_%s.csv" % (coWindow)
...
# result=[]
nowTime = tic.getNow().strftime('%Y%m%d_%H%M%S')
GlovePath = "output\keras_GloVeVec_%s_%s_%s.csv" % (coWindow, vecLength,max_iter)
